...
def add_test_args(parser):
    ...
    files.add_argument('--model_dir', type=str, default='/java/qa_models/',
    ...
    files.add_argument('--source_code_request_body', type=str,
                       help='Source code from request body to summarize')
...
def main(args):
    ...
    dev_exs = []
    ex = util.load_data_to_test(args, args.dataset_name[0])
    dev_exs.extend(ex)
